...
describe('<ProgressBar />', () => {
  ...
  it('should call componentDidMount', () => {
    ...
    const renderedComponent = mount(<ProgressBar percent={0} updateProgress={noop => noop} />);
  ...
  it('should unset ProgressBar.timeout after getting new props', () => {
    const renderedComponent = mount(<ProgressBar percent={100} updateProgress={noop => noop} />);
    const inst = renderedComponent.instance();
